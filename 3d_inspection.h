#ifndef 3D_Inspection_H
#define 3D_Inspection_H

#include <QtWidgets/QMainWindow>
#include "ui_3D_Inspection.h"
...
class 3D_Inspection : public QMainWindow
{
	Q_OBJECT

public:
	3D_Inspection(QWidget *parent = 0);
	~3D_Inspection();
...
private:
	Ui::3D_InspectionClass ui;
};

#endif // 3D_Inspection_H
