...
3D_Inspection::3D_Inspection(QWidget *parent)
	: QMainWindow(parent)
{
	ui.setupUi(this);
...
void 3D_Inspection::loadFileButtonPressed()
{
	QElapsedTimer timer;
...
void 3D_Inspection::DownloadPressed()
{
	//QString filename = QFileDialog::getOpenFileName(this, tr("Open point cloud"), "", tr("Point cloud data (*.pcd *.ply *.txt)"));
	QString filename = "//aidc-ntu3-pc/Users/Public/pointcloud.pcd";
	//ui.textEdit->append(filename);
...
void 3D_Inspection::saveButtonPressed()
{
...
void 3D_Inspection::Reset_3D_ViewPressed()
{
	viewer_->removeAllPointClouds();
	viewer_->removeAllShapes();
}

void 3D_Inspection::Reload_CloudPressed()
{
	if (cloudxyz->size())
	{
		pcl::copyPointCloud(*cloudxyz, *cloud_);
...
void 3D_Inspection::delay(int ms)
{
	// delay n (seconds)
...
void 3D_Inspection::OBB_Draw(const Cloud &input, QString name, bool remov)
{
...
void 3D_Inspection::Coordinate_Draw(bool remov)
{
	if (remov) viewer_->removeAllShapes();
...
void 3D_Inspection::Cloud_Display(const Cloud &input, QString name, int pointSize, bool removCloud, bool removeShape, bool resetCam)
{
	if (input.size() == 0)
	{
...
void 3D_Inspection::Reset_Project()
{
	ui.textEdit->clear();
...
void 3D_Inspection::SaveSingleScan()
{
	if (source_->size())
	{
		int return_status = 0;
...
void 3D_Inspection::SaveRegisScan()
{
	if (cloud_->size())
	{
		int return_status = 0;
...
// -----------------------------------------------------0--------------------------------------------------------
// Recognition
void 3D_Inspection::DownsamplePressed()
{
...
void 3D_Inspection::DenoisePressed()
{
...
void 3D_Inspection::DenoiseByNormalsPressed()
{
...
void 3D_Inspection::Denoise_by_segmentPressed()
{
...
void 3D_Inspection::Euclidean_Cluster_ExtractionPressed()
{
	ui.textEdit->clear();
...
void 3D_Inspection::Cylinder_FittingPressed()
{
	ui.textEdit->clear();
...
void 3D_Inspection::OBB_Recognition()
{
	QElapsedTimer timer;
...
void 3D_Inspection::SubOBB_Recognition()
{
	Cloud_Display(*cloud_, "Cloud", 2, true, true, true);
...
void 3D_Inspection::Non_Segmentation_SubOBB_Recognition()
{
...
void 3D_Inspection::RG_SubOBB_Recognition()
{
	if (cloud_->size() == 0) return;
	cInspection->objectName = ui.comboBox_ObjRecog->currentText();
...
void 3D_Inspection::Recognition_Error_ReportPressed()
{
...
// -----------------------------------------------------0--------------------------------------------------------
// Virtial Camera
void 3D_Inspection::Initial_Transformation_VirtualCam()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Point cloud is empty");
...
void 3D_Inspection::Generate_Database_VirtualCam()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Point cloud is empty");
...
void 3D_Inspection::Generate_Opt_Database()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Point cloud is empty");
...
void 3D_Inspection::Gennerate_NonSeg_Database()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Point cloud is empty");
...
// -----------------------------------------------------0--------------------------------------------------------
// Registration
void 3D_Inspection::Targe_Cloud()
{
	if (cloud_->size() == 0)
	{
...
void 3D_Inspection::Source_Cloud()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Cloud empty!");
...
void 3D_Inspection::OBB_Matching()
{
...
void 3D_Inspection::Regis_System_Positioning()
{
...
void 3D_Inspection::AutoRegis_System_Positioning()
{
	double X = ui.doubleBox_RegisX->text().toDouble();
	double Y = ui.doubleBox_RegisY->text().toDouble();
	double Z = ui.doubleBox_RegisZ->text().toDouble();
...
void 3D_Inspection::FrameBased_CoarseRegistration()
{
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr ModelCloud(new pcl::PointCloud<pcl::PointXYZRGB>);
...
void 3D_Inspection::AutoFrameBased_CoarseRegistration()
{
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr ModelCloud(new pcl::PointCloud<pcl::PointXYZRGB>);
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr spheres_cloud(new pcl::PointCloud<pcl::PointXYZRGB>);
	cInspection->objectName = "Spheres";
...
void 3D_Inspection::Frame_ICPPress()
{
	if (source_->size() == 0 || target_->size() == 0)
	{
		ui.textEdit->append("source or target is empty!");
...
void 3D_Inspection::ModDri_ICPPress()
{
	if (source_->size() == 0 || target_->size() == 0)
	{
		ui.textEdit->append("source or target is empty!");
...
void 3D_Inspection::Registration_Error_Report()
{
...
void 3D_Inspection::Regis_Model_Driven()
{
	if (cloud_->size() == 0)
	{
		ui.textEdit->append("Point cloud is empty");
...
void 3D_Inspection::Overlap_RemovalPress()
{
	if (cloud_->size() == 0) return;
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_Buf(new pcl::PointCloud<pcl::PointXYZ>());
	pcl::copyPointCloud(*cloud_, *cloud_Buf);
...
// -----------------------------------------------------0--------------------------------------------------------
// Test Mode
void 3D_Inspection::Pick_and_Place_TestPressed()
{
...
void 3D_Inspection::FrameBall_DetectionPress()
{
	ui.textEdit->append("\n");
...
void 3D_Inspection::Frame_Matching()
{
	ui.textEdit->append("\n");
...
void 3D_Inspection::TestFrameCali_Start()
{
	Reset_Project();
	scanMethod = 3;
	frameScan = true;
...
void 3D_Inspection::TestFrame_Pause()
{
	robotPause = true;
}

void 3D_Inspection::TestFrame_Continue()
{
...
void 3D_Inspection::TestFrame_SaveTransf()
{
...
void 3D_Inspection::OnlineFrameCalibration()
{
	ui.textEdit->append("\n");
...
void 3D_Inspection::AutoScanningPressed()
{
	Reset_Project();
	scanMethod = 1;
	viewIndex = 0;
...
void  3D_Inspection::Frame_Based_Scan()
{
	Reset_Project();
	scanMethod = 2;
	frameScan = true;
...
void 3D_Inspection::AutoMode_Pause()
{
	robotPause = true;
}

void 3D_Inspection::AutoMode_Continue()
{
	robotPause = false;
}

void 3D_Inspection::OnlineRobotPositiningRegitration()
{
	ui.textEdit->append("");
...
void 3D_Inspection::OnlineFrameBasedRegitration()
{
	ui.textEdit->append("");
	ui.textEdit->append("Scan: " + QString::number(viewIndex));
...
void 3D_Inspection::bt_ListenKukaButtonPressed()
{
...
void 3D_Inspection::writeData_Kuka()
{
...
void 3D_Inspection::myConnection_Kuka()
{
...
void 3D_Inspection::readData_Auto_Kuka()
{
...
void 3D_Inspection::readData_Kuka()
{
...
void 3D_Inspection::Origin_KukaPressed()
{
	moveOrigin = true;
}

void 3D_Inspection::Move_KukaPressed()
{
	robotMove = true;
}
...
void 3D_Inspection::bt_ListenProbeButtonPressed()
{
...
void 3D_Inspection::myConnection_Probe()
{
...
void 3D_Inspection::readData_Auto_Probe()
{
	// Read data
	QByteArray data = socket_Probe->readAll();
	QString DataAsString(data);
...
void 3D_Inspection::writeData_Probe()
{
...
// -----------------------------------------------------0--------------------------------------------------------
// Rotational Table
void 3D_Inspection::rotaTable_Connect()
{
	rotationalTable->Open();
	rotationalTable->Move("HSPD=10000");
}

void 3D_Inspection::rotaTable_Disconnect()
{
	fnPerformaxComClose(rotationalTable->m_hUSBDevice);
}

void 3D_Inspection::rotaTable_Move_60_Degree()
{
...
void 3D_Inspection::rotaTab_ZeroPos()
{
	rotationalTable->Move("X0");
	delay(3000);
	rotaPos = 0;
...
void 3D_Inspection::rotaTable_Move()
{
...
// -----------------------------------------------------0--------------------------------------------------------
// Tools and Examples
void 3D_Inspection::ICP_ExamplePressed()
{
	// ICP Example
...
void 3D_Inspection::SVD_ExamplePressed()
{
...
void 3D_Inspection::ToolTestPress()
{
...
void 3D_Inspection::Sphere_Detection()
{
	if (!segmented_cloud->size())
	{
		ui.textEdit->append("Segmented Cloud is empty");
...
// -----------------------------------------------------0--------------------------------------------------------
// Plot
void 3D_Inspection::Initial_2D_Graph()
{
	// Plotter or Charts
...
void 3D_Inspection::Line_2D_Graph()
{
	//setting some properties
...
void 3D_Inspection::Update_Line_2D_Graph(pcl::PointCloud<pcl::PointXYZ> &input)
{
	double *array_X = new double[1];
	double *array_Y = new double[1];
...
void 3D_Inspection::Recog_SubOBB_Checkbox()
{
...
void 3D_Inspection::Recog_OSubOBB_Checkbox()
{
...
void 3D_Inspection::Recog_nonSegSubOBB_Checkbox()
{
	ui.checkBox_SubOBB_Recognition->setChecked(false);
	ui.checkBox_OSubOBB_Recognition->setChecked(false);
